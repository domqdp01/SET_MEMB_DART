...
from function_needed import throttle_dynamics_data_processing, steering_2_steering_angle, evaluate_slip_angles, lateral_tire_force, rolling_friction, motor_force, F_friction_due_to_steering
...
tau_filt = throttle_dynamics_data_processing(df)
